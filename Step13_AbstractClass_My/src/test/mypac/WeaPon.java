package test.mypac; //추상클래스와 인터페이스
/*
 ...
 *  - 추상 클래스 type 의 id 가 필요하다면 추상 클래스를 상속 받은 자식 클래스를 정의해서 객체를 생성한다.
 *  - 추상 클래스를 상속받은 자식 클래스는 부모 추상메소드를 모두 오버라이드(재정의) 해야 한다.
 */
//추상 클래스
